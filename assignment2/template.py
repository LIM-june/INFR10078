...
class HMM:
    ...
    def emission_model(self, train_data):
        ...
        self.emission_PD = ConditionalProbDist(emission_FD, LidstoneProbDist, 0.001, 7635)
        self.states = emission_FD.conditions()

        # print('---------')
        # print(len(emission_FD))
        # print(emission_FD.items())
        # print(emission_FD.values())
        # print(len(data))
        # print(emission_FD.conditions())
        # print(self.states)
        # print(emission_FD.tabulate())
        # print(emission_FD.N())
        # print(self.emission_PD.items())
        # print(self.emission_PD['VERB'].prob('is'))
        # print(log(0.05026255324802739,2))
        # print(log(self.emission_PD['VERB'].prob('is'),2))
        # print('---------')
